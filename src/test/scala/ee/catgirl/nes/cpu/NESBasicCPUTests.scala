...
class NESBasicCPUTests extends AnyFlatSpec with ChiselScalatestTester with ParallelTestExecution {
  ...
  it should "be able to pass 01-basics.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/01-basics.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 1000000)
  }

  it should "be able to pass 02-implied.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/02-implied.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 10000000)
  }
  ...
  it should "be able to pass 10-branches.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/10-branches.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 10000000)
  }

  it should "be able to pass 11-stack.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/11-stack.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 10000000)
  }

  it should "be able to pass 12-jmp_jsr.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/12-jmp_jsr.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 10000000)
  }

  it should "be able to pass 13-rts.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/13-rts.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 10000000)
  }

  it should "be able to pass 14-rti.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/14-rti.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 10000000)
  }

  it should "be able to pass 15-brk.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/15-brk.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 10000000)
  }

  it should "be able to pass 16-special.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/rom_singles/16-special.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 10000000)
  }

  it should "be able to pass official_only.nes" in {
    test(new ROMTester(romPath = getClass.getResource("/instr_test-v5/official_only.nes").getPath)).withAnnotations(NOVCDAnnos).runUntilStop(timeout = 100000000)
  }
}
